# Generated by Django 6.0.5 on 2026-05-17 09:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("surname", models.CharField(blank=True, help_text="Прізвище мешканця", max_length=100, null=True)),
                ("name", models.CharField(blank=True, help_text="Ім'я мешканця", max_length=100, null=True)),
                ("middle_name", models.CharField(blank=True, help_text="По батькові", max_length=100, null=True)),
                (
                    "year",
