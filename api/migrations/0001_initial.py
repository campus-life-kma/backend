# Generated by Django 6.0.5 on 2026-06-14 14:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_blocked",
                    models.BooleanField(default=False, help_text="Якщо True, ресурс недоступний для бронювання"),
                ),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("status", models.CharField(blank=True, help_text="Короткий статус або настрій", max_length=100)),
                ...
                (
                    "is_activated",
                    models.BooleanField(default=False, help_text="Прапорець активації після першого логіну"),
                ),
                (
                    "groups",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_blocked",
                    models.BooleanField(
                        default=False, help_text="Якщо True, кімната повністю недоступна (наприклад, через ремонт)"
                    ),
                ),
                (
                    "svg_element_id",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_pinned",
                    models.BooleanField(default=False, help_text="Якщо True, оголошення буде закріплене вгорі стрічки"),
                ),
                (
                    "creator",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "read_at",
                    models.DateTimeField(auto_now_add=True, help_text="Точний час, коли користувач відкрив оголошення"),
                ),
                (
                    "announcement",
                    models.ForeignKey(
